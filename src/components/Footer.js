        ...
        <div className="footer container-fluid position-relative d-md-flex p-5 footer text-white  bg-dark" style={{marginBottom: '-20px'}}>
            <div className="links text-center text-md-start ps-md-5 ms-md-5 col-12 col-md-4">
                ...
                <div className="link-icons mt-5 mb-3">
                    <img className="me-3" src="/images/facebook.svg" alt="" />
                    <img className="me-3" src="/images/twitter.svg" alt="" />
                    <img className="me-3" src="/images/insta.svg" alt="" />
                </div>
            ...
            <div className="products col-12 col-md-2">
                <ul className="text-white-50 list-unstyled">
                    <li className="footer-product-heading text-white mb-2">Products <span className="d-md-none float-end"><ArrowDropDownIcon/></span></li>
            ...
            <ul className="text-white-50  list-unstyled">
                    ...
                    <li className="footer-service-heading text-white mb-2">Servies<span className="d-md-none float-end"><ArrowDropDownIcon/></span></li>
            ...
            <div className="contact col-12 col-md-3">
                <ul className=" list-unstyled">
                    <li className="footer-contact-heading mb-2">Contact Information<span className="d-md-none float-end"><ArrowDropDownIcon/></span></li>
